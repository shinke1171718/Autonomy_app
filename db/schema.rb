...
ActiveRecord::Schema[7.0].define(version: 2023_08_05_082505) do
  ...
  create_table "temp_ingredients", force: :cascade do |t|
    t.string "name", default: "", null: false
    t.integer "quantity", null: false
    t.string "unit", default: "", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_temp_ingredients_on_user_id"
  end
  ...
  add_foreign_key "temp_ingredients", "users"
end
